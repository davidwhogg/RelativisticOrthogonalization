...
For you an inner product $\Evec{u}^\top\Evec{v}$ is written as a braket $\braket{\Evec{u}}{\Evec{v}}$, and an outer product $\Evec{u}\,\Evec{v}^\top$ is written as a ketbra $\ketbra{\Evec{u}}{\Evec{v}}$.
...
\begin{align}
  ...
  &= \sum_{j=1}^{d+1} \ketbra{\Lhat{u}'_j}{\Lhat{u}_j} ~~ \mbox{provided that} ~ \braket{\Lhat{u}'_j}{\Lhat{u}'_j} = \braket{\Lhat{u}_j}{\Lhat{u}_j} ~ \mbox{for all $j$} \label{eq:LTQM},
\end{align}
...
\begin{align}
    Q &= \frac{1}{\inner{\Lhat{u}}{\Lhat{u}}}\,[\Lhat{u}'\,\Lhat{u}^\top\metric - \Lhat{u}\,\Lhat{u}'^\top\metric + \inner{\Lhat{u}}{\Lhat{u}'}\,\proj_{1+1}] + \proj_{d-1} ~~ \mbox{provided that} ~ \inner{\Lhat{u}'}{\Lhat{u}'} = \inner{\Lhat{u}}{\Lhat{u}} \\
      &= \ketbra{\Lhat{u}'}{\Lhat{u}} - \ketbra{\Lhat{u}}{\Lhat{u}'} + \frac{\braket{\Lhat{u}}{\Lhat{u}'}}{\braket{\Lhat{u}}{\Lhat{u}}}\,\proj_{1+1} + \proj_{d-1} ~~ \mbox{provided that} ~ \braket{\Lhat{u}'}{\Lhat{u}'} = \braket{\Lhat{u}}{\Lhat{u}} ~,
\end{align}
